"use strict";(()=>{var e={};e.id=770,e.ids=[770],e.modules={85890:e=>{e.exports=require("better-sqlite3")},20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},92048:e=>{e.exports=require("fs")},55315:e=>{e.exports=require("path")},14910:(e,t,r)=>{r.r(t),r.d(t,{originalPathname:()=>l,patchFetch:()=>_,requestAsyncStorage:()=>u,routeModule:()=>c,serverHooks:()=>N,staticGenerationAsyncStorage:()=>R});var E={};r.r(E),r.d(E,{DELETE:()=>p,GET:()=>i,PUT:()=>n});var s=r(49303),a=r(88716),d=r(60670),T=r(87070),o=r(9487);async function i(e,{params:t}){try{let e=parseInt(t.id);if(isNaN(e))return T.NextResponse.json({success:!1,error:"无效的ID"},{status:400});let r=o.eN.getById(e);if(!r)return T.NextResponse.json({success:!1,error:"MCP服务器不存在"},{status:404});return T.NextResponse.json({success:!0,data:r})}catch(e){return console.error("获取MCP服务器失败:",e),T.NextResponse.json({success:!1,error:"获取MCP服务器失败"},{status:500})}}async function n(e,{params:t}){try{let r=parseInt(t.id);if(isNaN(r))return T.NextResponse.json({success:!1,error:"无效的ID"},{status:400});let{name:E,description:s,server_type:a,config:d,status:i,enabled:n}=await e.json(),p={};void 0!==E&&(p.name=E),void 0!==s&&(p.description=s),void 0!==a&&(p.server_type=a),void 0!==d&&(p.config="string"==typeof d?d:JSON.stringify(d)),void 0!==i&&(p.status=i),void 0!==n&&(p.enabled=n);let c=o.eN.update(r,p);if(!c)return T.NextResponse.json({success:!1,error:"MCP服务器不存在"},{status:404});return T.NextResponse.json({success:!0,data:c})}catch(e){return console.error("更新MCP服务器失败:",e),T.NextResponse.json({success:!1,error:"更新MCP服务器失败"},{status:500})}}async function p(e,{params:t}){try{let e=parseInt(t.id);if(isNaN(e))return T.NextResponse.json({success:!1,error:"无效的ID"},{status:400});if(!o.eN.delete(e))return T.NextResponse.json({success:!1,error:"MCP服务器不存在"},{status:404});return T.NextResponse.json({success:!0})}catch(e){return console.error("删除MCP服务器失败:",e),T.NextResponse.json({success:!1,error:"删除MCP服务器失败"},{status:500})}}let c=new s.AppRouteRouteModule({definition:{kind:a.x.APP_ROUTE,page:"/api/mcp/[id]/route",pathname:"/api/mcp/[id]",filename:"route",bundlePath:"app/api/mcp/[id]/route"},resolvedPagePath:"/Users/duanlingxiao/test/app/api/mcp/[id]/route.ts",nextConfigOutput:"",userland:E}),{requestAsyncStorage:u,staticGenerationAsyncStorage:R,serverHooks:N}=c,l="/api/mcp/[id]/route";function _(){return(0,d.patchFetch)({serverHooks:N,staticGenerationAsyncStorage:R})}},9487:(e,t,r)=>{r.d(t,{Dy:()=>c,K0:()=>R,P4:()=>N,_9:()=>l,eN:()=>u});var E=r(85890),s=r.n(E),a=r(55315),d=r.n(a),T=r(92048),o=r.n(T);let i=d().join(process.cwd(),"data","knowledge_base.db"),n=d().dirname(i);o().existsSync(n)||o().mkdirSync(n,{recursive:!0});let p=new(s())(i);p.exec(`

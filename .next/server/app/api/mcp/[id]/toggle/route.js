"use strict";(()=>{var e={};e.id=456,e.ids=[456],e.modules={85890:e=>{e.exports=require("better-sqlite3")},20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},92048:e=>{e.exports=require("fs")},55315:e=>{e.exports=require("path")},45213:(e,t,r)=>{r.r(t),r.d(t,{originalPathname:()=>R,patchFetch:()=>l,requestAsyncStorage:()=>p,routeModule:()=>n,serverHooks:()=>u,staticGenerationAsyncStorage:()=>c});var E={};r.r(E),r.d(E,{POST:()=>o});var a=r(49303),T=r(88716),d=r(60670),s=r(87070),i=r(9487);async function o(e,{params:t}){try{let e=parseInt(t.id);if(isNaN(e))return s.NextResponse.json({success:!1,error:"无效的ID"},{status:400});let r=i.eN.toggleEnabled(e);if(!r)return s.NextResponse.json({success:!1,error:"MCP服务器不存在"},{status:404});return s.NextResponse.json({success:!0,data:r})}catch(e){return console.error("切换MCP服务器状态失败:",e),s.NextResponse.json({success:!1,error:"切换MCP服务器状态失败"},{status:500})}}let n=new a.AppRouteRouteModule({definition:{kind:T.x.APP_ROUTE,page:"/api/mcp/[id]/toggle/route",pathname:"/api/mcp/[id]/toggle",filename:"route",bundlePath:"app/api/mcp/[id]/toggle/route"},resolvedPagePath:"/Users/duanlingxiao/test/app/api/mcp/[id]/toggle/route.ts",nextConfigOutput:"",userland:E}),{requestAsyncStorage:p,staticGenerationAsyncStorage:c,serverHooks:u}=n,R="/api/mcp/[id]/toggle/route";function l(){return(0,d.patchFetch)({serverHooks:u,staticGenerationAsyncStorage:c})}},9487:(e,t,r)=>{r.d(t,{Dy:()=>c,K0:()=>R,P4:()=>l,_9:()=>_,eN:()=>u});var E=r(85890),a=r.n(E),T=r(55315),d=r.n(T),s=r(92048),i=r.n(s);let o=d().join(process.cwd(),"data","knowledge_base.db"),n=d().dirname(o);i().existsSync(n)||i().mkdirSync(n,{recursive:!0});let p=new(a())(o);p.exec(`

"use strict";(()=>{var e={};e.id=684,e.ids=[684],e.modules={85890:e=>{e.exports=require("better-sqlite3")},20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},92048:e=>{e.exports=require("fs")},55315:e=>{e.exports=require("path")},59936:(e,t,r)=>{r.r(t),r.d(t,{originalPathname:()=>_,patchFetch:()=>l,requestAsyncStorage:()=>c,routeModule:()=>p,serverHooks:()=>R,staticGenerationAsyncStorage:()=>u});var E={};r.r(E),r.d(E,{GET:()=>o,POST:()=>n});var a=r(49303),T=r(88716),d=r(60670),s=r(87070),i=r(9487);async function o(e){try{let t;let r=e.nextUrl.searchParams.get("category");return t=r?i.K0.getByCategory(r):i.K0.getAll(),s.NextResponse.json(t)}catch(e){return s.NextResponse.json({error:"获取商品失败"},{status:500})}}async function n(e){try{let t=await e.json(),r=i.K0.create(t);return s.NextResponse.json(r,{status:201})}catch(e){return s.NextResponse.json({error:"创建商品失败"},{status:500})}}let p=new a.AppRouteRouteModule({definition:{kind:T.x.APP_ROUTE,page:"/api/products/route",pathname:"/api/products",filename:"route",bundlePath:"app/api/products/route"},resolvedPagePath:"/Users/duanlingxiao/test/app/api/products/route.ts",nextConfigOutput:"",userland:E}),{requestAsyncStorage:c,staticGenerationAsyncStorage:u,serverHooks:R}=p,_="/api/products/route";function l(){return(0,d.patchFetch)({serverHooks:R,staticGenerationAsyncStorage:u})}},9487:(e,t,r)=>{r.d(t,{Dy:()=>c,K0:()=>R,P4:()=>_,_9:()=>l,eN:()=>u});var E=r(85890),a=r.n(E),T=r(55315),d=r.n(T),s=r(92048),i=r.n(s);let o=d().join(process.cwd(),"data","knowledge_base.db"),n=d().dirname(o);i().existsSync(n)||i().mkdirSync(n,{recursive:!0});let p=new(a())(o);p.exec(`

"use strict";(()=>{var e={};e.id=747,e.ids=[747],e.modules={85890:e=>{e.exports=require("better-sqlite3")},20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},92048:e=>{e.exports=require("fs")},55315:e=>{e.exports=require("path")},27071:(e,t,r)=>{r.r(t),r.d(t,{originalPathname:()=>l,patchFetch:()=>N,requestAsyncStorage:()=>u,routeModule:()=>c,serverHooks:()=>_,staticGenerationAsyncStorage:()=>R});var E={};r.r(E),r.d(E,{DELETE:()=>p,GET:()=>n,PUT:()=>o});var a=r(49303),s=r(88716),d=r(60670),T=r(87070),i=r(9487);async function n(e,{params:t}){try{let e=parseInt(t.id),r=i.Dy.getById(e);if(!r)return T.NextResponse.json({success:!1,error:"知识条目不存在"},{status:404});return T.NextResponse.json({success:!0,data:r})}catch(e){return T.NextResponse.json({success:!1,error:"获取知识条目失败"},{status:500})}}async function o(e,{params:t}){try{let r=parseInt(t.id),E=await e.json(),a=i.Dy.update(r,E);if(!a)return T.NextResponse.json({success:!1,error:"知识条目不存在"},{status:404});return T.NextResponse.json({success:!0,data:a})}catch(e){return T.NextResponse.json({success:!1,error:"更新知识条目失败"},{status:500})}}async function p(e,{params:t}){try{let e=parseInt(t.id);if(!i.Dy.delete(e))return T.NextResponse.json({success:!1,error:"知识条目不存在"},{status:404});return T.NextResponse.json({success:!0})}catch(e){return T.NextResponse.json({success:!1,error:"删除知识条目失败"},{status:500})}}let c=new a.AppRouteRouteModule({definition:{kind:s.x.APP_ROUTE,page:"/api/knowledge/[id]/route",pathname:"/api/knowledge/[id]",filename:"route",bundlePath:"app/api/knowledge/[id]/route"},resolvedPagePath:"/Users/duanlingxiao/test/app/api/knowledge/[id]/route.ts",nextConfigOutput:"",userland:E}),{requestAsyncStorage:u,staticGenerationAsyncStorage:R,serverHooks:_}=c,l="/api/knowledge/[id]/route";function N(){return(0,d.patchFetch)({serverHooks:_,staticGenerationAsyncStorage:R})}},9487:(e,t,r)=>{r.d(t,{Dy:()=>c,K0:()=>R,P4:()=>_,_9:()=>l,eN:()=>u});var E=r(85890),a=r.n(E),s=r(55315),d=r.n(s),T=r(92048),i=r.n(T);let n=d().join(process.cwd(),"data","knowledge_base.db"),o=d().dirname(n);i().existsSync(o)||i().mkdirSync(o,{recursive:!0});let p=new(a())(n);p.exec(`

"use strict";(()=>{var e={};e.id=591,e.ids=[591],e.modules={85890:e=>{e.exports=require("better-sqlite3")},20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},92048:e=>{e.exports=require("fs")},55315:e=>{e.exports=require("path")},86100:(e,t,r)=>{r.r(t),r.d(t,{originalPathname:()=>l,patchFetch:()=>_,requestAsyncStorage:()=>c,routeModule:()=>p,serverHooks:()=>R,staticGenerationAsyncStorage:()=>u});var E={};r.r(E),r.d(E,{GET:()=>o,POST:()=>n});var a=r(49303),s=r(88716),T=r(60670),d=r(87070),i=r(9487);async function o(e){try{let t;let r=e.nextUrl.searchParams,E=r.get("keyword"),a=r.get("category");return t=E&&a?i.Dy.search(E).filter(e=>e.category===a):E?i.Dy.search(E):a?i.Dy.getByCategory(a):i.Dy.getAll(),d.NextResponse.json({success:!0,data:t})}catch(e){return d.NextResponse.json({success:!1,error:"获取知识条目失败"},{status:500})}}async function n(e){try{let{title:t,content:r,category:E,tags:a,author:s}=await e.json();if(!t||!r)return d.NextResponse.json({success:!1,error:"标题和内容不能为空"},{status:400});let T=i.Dy.create({title:t,content:r,category:E,tags:a,author:s});return d.NextResponse.json({success:!0,data:T},{status:201})}catch(e){return d.NextResponse.json({success:!1,error:"创建知识条目失败"},{status:500})}}let p=new a.AppRouteRouteModule({definition:{kind:s.x.APP_ROUTE,page:"/api/knowledge/route",pathname:"/api/knowledge",filename:"route",bundlePath:"app/api/knowledge/route"},resolvedPagePath:"/Users/duanlingxiao/test/app/api/knowledge/route.ts",nextConfigOutput:"",userland:E}),{requestAsyncStorage:c,staticGenerationAsyncStorage:u,serverHooks:R}=p,l="/api/knowledge/route";function _(){return(0,T.patchFetch)({serverHooks:R,staticGenerationAsyncStorage:u})}},9487:(e,t,r)=>{r.d(t,{Dy:()=>c,K0:()=>R,P4:()=>l,_9:()=>_,eN:()=>u});var E=r(85890),a=r.n(E),s=r(55315),T=r.n(s),d=r(92048),i=r.n(d);let o=T().join(process.cwd(),"data","knowledge_base.db"),n=T().dirname(o);i().existsSync(n)||i().mkdirSync(n,{recursive:!0});let p=new(a())(o);p.exec(`
...
`);let c={getAll:()=>p.prepare("SELECT * FROM knowledge_items ORDER BY updated_at DESC").all(),getById:e=>p.prepare("SELECT * FROM knowledge_items WHERE id = ?").get(e),create:e=>{let t=p.prepare(`
    ...
    `).run(e.customer_name,e.customer_email,e.customer_phone||null,e.customer_address,e.total_amount,e.status||"pending").lastInsertRowid,E=p.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?)
    `);for(let e of t)E.run(r,e.product_id,e.product_name,e.product_price,e.quantity);return _.getById(r)},updateStatus:(e,t)=>(p.prepare("UPDATE orders SET status = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").run(t,e),_.getById(e))}}};var t=require("../../../webpack-runtime.js");t.C(e);var r=e=>t(t.s=e),E=t.X(0,[276,972],()=>r(86100));module.exports=E})();
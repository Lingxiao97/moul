"use strict";(()=>{var e={};e.id=87,e.ids=[87],e.modules={85890:e=>{e.exports=require("better-sqlite3")},20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},92048:e=>{e.exports=require("fs")},55315:e=>{e.exports=require("path")},21418:(e,t,r)=>{r.r(t),r.d(t,{originalPathname:()=>_,patchFetch:()=>l,requestAsyncStorage:()=>u,routeModule:()=>p,serverHooks:()=>R,staticGenerationAsyncStorage:()=>c});var E={};r.r(E),r.d(E,{GET:()=>o,PUT:()=>n});var a=r(49303),d=r(88716),T=r(60670),s=r(87070),i=r(9487);async function o(e,{params:t}){try{let e=i._9.getById(parseInt(t.id));if(!e)return s.NextResponse.json({error:"订单不存在"},{status:404});return s.NextResponse.json(e)}catch(e){return s.NextResponse.json({error:"获取订单失败"},{status:500})}}async function n(e,{params:t}){try{let r=await e.json(),E=i._9.updateStatus(parseInt(t.id),r.status);if(!E)return s.NextResponse.json({error:"订单不存在"},{status:404});return s.NextResponse.json(E)}catch(e){return s.NextResponse.json({error:"更新订单失败"},{status:500})}}let p=new a.AppRouteRouteModule({definition:{kind:d.x.APP_ROUTE,page:"/api/orders/[id]/route",pathname:"/api/orders/[id]",filename:"route",bundlePath:"app/api/orders/[id]/route"},resolvedPagePath:"/Users/duanlingxiao/test/app/api/orders/[id]/route.ts",nextConfigOutput:"",userland:E}),{requestAsyncStorage:u,staticGenerationAsyncStorage:c,serverHooks:R}=p,_="/api/orders/[id]/route";function l(){return(0,T.patchFetch)({serverHooks:R,staticGenerationAsyncStorage:c})}},9487:(e,t,r)=>{r.d(t,{Dy:()=>u,K0:()=>R,P4:()=>_,_9:()=>l,eN:()=>c});var E=r(85890),a=r.n(E),d=r(55315),T=r.n(d),s=r(92048),i=r.n(s);let o=T().join(process.cwd(),"data","knowledge_base.db"),n=T().dirname(o);i().existsSync(n)||i().mkdirSync(n,{recursive:!0});let p=new(a())(o);p.exec(`
